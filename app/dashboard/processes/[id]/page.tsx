      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-xl md:text-3xl font-bold text-slate-900 truncate">{process.title}</h1>
            <p className="text-slate-600 mt-1 text-sm md:text-base">Detalhes do processo</p>
          </div>
        </div>
        <Link href={`/dashboard/processes/${id}/edit`} className="flex-1 sm:flex-initial">
